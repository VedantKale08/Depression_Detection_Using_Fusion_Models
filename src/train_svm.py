...
def main():
    ...
    print("Extracting participant-level features for Linear SVM...")
    ...
    print("\nTraining Linear SVM...")
    # kernel='linear' makes it a Linear SVM
    # class_weight='balanced' automatically handles the depressed vs non-depressed imbalance
    # C=0.05 provides very strong regularization to prevent overfitting in our small dataset 
    model = SVC(kernel='linear', class_weight='balanced', C=0.05, random_state=42)
